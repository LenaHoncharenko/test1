...
async function testEverything( ) {
    ...
    await driver.manage( ).addCookie( {name:"PHPSESSID", value:"a6a8bfa5481b38ac40fa2ce30ab9c13a"} );
    await driver.manage( ).addCookie( {name:"DeviceCode", value:"98042d218ec6732f97ab721813a09a05"} );
    await driver.get( 'https://my.novaposhta.ua/auth/index' );
